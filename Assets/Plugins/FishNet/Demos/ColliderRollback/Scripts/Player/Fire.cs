...
namespace FishNet.Example.ColliderRollbacks
{
    ...
    public class Fire : NetworkBehaviour
    {
        ...
        private Aim _aim;
        /// <summary>
        /// Differences in hit registration.
        /// </summary>
        ...
        private void CheckFire()
        {
            ...
            ServerFire(base.TimeManager.GetPreciseTick(base.TimeManager.LastPacketTick.Value()), start, direction);
        }
        ...
        private void CheckFireDemo()
        {
            ...
            if (Physics.Raycast(ray, out hit, float.PositiveInfinity, _hitboxLayer))
            {
                ...
                {
                    PreciseTick pt = base.TimeManager.GetPreciseTick(base.TimeManager.LastPacketTick.Value());
        ...
        private void ServerFireDemo(PreciseTick pt, Vector3 start, Vector3 direction, NetworkObject hitObject, Vector3 hitIdentityPosition)
        {
            ...
            if (!base.IsClientStarted)
            {
                ...
                Debug.Log($"Difference {difference.ToString("0.000")}m. Average difference {averageDifference.ToString("0.000")}m.");
            }
